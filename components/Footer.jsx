...
<h4 className="font-bold md:text-[44px] flex flex-col text-[34px] text-white" >Build Bridge <span className="text-base text-slate-500">Where innovation meets imagination.</span></h4>
...
<div className="flex items-center justify-between flex-wrap gap-4">
  <h4 className="font-extrabold text-[24px] text-white" >Build Bridge</h4>
